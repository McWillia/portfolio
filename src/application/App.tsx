  ...
  return (
    <Flex className="App" h={"100%"} position={"relative"}>
      ...
      <Flex w={"600px"} minH={"100%"} flexShrink={0} >
        <Castle skyColour={`${COLOUR_THEME_OPTIONS[colourThemeVal]}.light.500`} buildingColour={`${COLOUR_THEME_OPTIONS[colourThemeVal]}.primary.500`} />
      </Flex>
      

      <Flex paddingTop={32} paddingLeft={5} bg={`${COLOUR_THEME_OPTIONS[colourThemeVal]}.light.500`}  direction={"column"}  flexShrink={1}>
        
        {/* ---------------------- ABOUT SECTION ---------------------- */}
        <BubbleCard padding={2} marginBottom={5} flexDirection={"column"}>
          <Text fontSize={"3xl"} fontFamily={"silk"} id="about_section">About</Text>
          
          <Text>
            I am a young professional trained in software engineering and software development practices. 
            ...
            I am looking at frontend roles 
          </Text>
        </BubbleCard>
        ...
        <BubbleCard padding={2} marginBottom={5} flexDirection={"column"}>
          <Text fontSize={"3xl"} fontFamily={"silk"} id="cert_section">Certification</Text>
            <Experience 
              key="cert_csm"
              ...
              blurb={"I validated my knowledge and understanding of agile methodologies and their use in practical software development as well as better understand the nuance of the roles and responsibilities of the product and development teams."} 
            />
        </BubbleCard>
        ...
        <BubbleCard padding={2} marginBottom={5} flexDirection={"column"}>
          <Text fontSize={"3xl"} fontFamily={"silk"} id="tech_section">Technologies Used</Text>
          
          §  Language/ Tech: HTML, CSS, JavaScript, TypeScript, React, SCSS, NodeJS, Cube JS, JQuery, Directus, OAuth
          <br/>
          §  Databases: MySQL, POSTGRESQL, MariaDB
          <br/>

          §  Tools/Frameworks: Spring Boot, Docker, Jenkins CI/CD, Git, JIRA, SonarQube,  Storybook, Teamcity
          <br/>

          §  Methods and techniques: Agile, Scrum, Kanban, Waterfall
          <br/>

          §  Software modelling tools: Archimate
        ...
        <BubbleCard padding={2} marginBottom={5} flexDirection={"column"}>
          <Text fontSize={"3xl"} fontFamily={"silk"} id="xp_section">Experience</Text>
          <Experience 
            key="xp_bw"
        ...
        <BubbleCard padding={2} marginBottom={5} flexDirection={"column"}>
          <Text fontSize={"3xl"} fontFamily={"silk"} id="xp_section">About the Site</Text>

          I built this site using React and Typescript. 
          It makes use of the Chakra UI component library for the styled system and uses Vite as the build manager.  
          I made use of redux for the theme control in order to not need to pass around a theme key to every child, instead letting them pull from the global state if they need to interact.
